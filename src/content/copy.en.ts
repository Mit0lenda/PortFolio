...
export const copyEn: Copy = {
  ...
  projects: {
    ...
    labelProj: "PROJECT",
    list: [
      { name: "PromoCode", tag: "AI Agent · WhatsApp shopping consultant", trophy: "// MVP IN PRODUCTION · N8N + AI + SUPABASE", desc: "WhatsApp shopping consultant: understands budget, use case and urgency in natural language, decides with an AI agent (LangChain + tools), remembers conversation history and learns from every recommendation via vector memory (RAG). Architecture: n8n orchestrating the agent, Chatwoot as the inbox (a human can take over any conversation at any time), Supabase with pgvector for memory, and Node.js for product search and ranking. Marketplace integration in progress." },
