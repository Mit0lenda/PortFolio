...
export const copyEn: Copy = {
  ...
  projects: {
    ...
    list: [
      ...
      { id: "infra-comunicacao", name: "Infrastructure Migration", tag: "Infrastructure · Systems migration", trophy: "// COMPLETED · GOOGLE WORKSPACE + TWILIO", desc: "Migrated ~80 email accounts to Google Workspace with a plan-mixing strategy to cut licensing cost, and moved the support channel from SMS to WhatsApp via Twilio/WABA." },
    ],
