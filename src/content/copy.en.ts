...
export const copyEn: Copy = {
  ...
  projects: {
    ...
    list: [
      ...
      { id: "reddy", name: "Reddy", tag: "AI · Automated support", trophy: "// MVP IN PRODUCTION · N8N + AI + WHATSAPP", desc: "AI agent that takes over technical support on WhatsApp: guided diagnostic flow (signup → connection → device), automatic language detection by country code and conversation memory, cutting reliance on human agents for recurring triage." },
      { id: "cpm", name: "CPM", tag: "Custom Web System · Sales CRM", trophy: "// MVP IN DEVELOPMENT · REACT + NESTJS", desc: "Sales CRM built from scratch: sales pipeline, funnel, analytics and automatic detection of stalled opportunities (\"Anti-Limbo\"), with separate production/staging environments and branch-controlled deploys." },
      { id: "dashboard-financeiro", name: "Financial Dashboard", tag: "BI · Business Intelligence", trophy: "// DELIVERED & VALIDATED · SQL + BI", desc: "Full industrial P&L modeling (gross revenue, COGS, gross margin, EBITDA, net income) built from the ERP's financial entries, with an executive KPI dashboard and 1:1 parity validation against native reports." },
      { id: "infra-comunicacao", name: "Infrastructure Migration", tag: "Infrastructure · Systems migration", trophy: "// COMPLETED · GOOGLE WORKSPACE + TWILIO", desc: "Migrated ~50 email accounts to Google Workspace with a plan-mixing strategy to cut licensing cost, and moved the support channel from SMS to WhatsApp via Twilio/WABA." },
    ],
