...
export const copyEs: Copy = {
  ...
  projects: {
    ...
    list: [
      ...
      { id: "atlas", name: "Atlas",      tag: "Sistema financiero FGTS",      trophy: "// EN PRODUCCIÓN · FREELANCE",       desc: "Sistema financiero FGTS completo para un equipo comercial. CRM de propuestas, agenda, consultas masivas, exportación de reportes." },
