...
export const copyEs: Copy = {
  ...
  projects: {
    ...
    list: [
      ...
      { id: "reddy", name: "Reddy", tag: "IA · Atención automatizada", trophy: "// MVP EN PRODUCCIÓN · N8N + IA + WHATSAPP", desc: "Agente de IA que asume el soporte técnico por WhatsApp: flujo de diagnóstico guiado (registro → conexión → dispositivo), detección automática de idioma por código de país y memoria de conversación, reduciendo la dependencia de atención humana en triages recurrentes." },
      { id: "cpm", name: "CPM", tag: "Sistema Web a Medida · CRM comercial", trophy: "// MVP EN DESARROLLO · REACT + NESTJS", desc: "CRM comercial construido desde cero: pipeline de ventas, embudo, analytics y detección automática de oportunidades sin seguimiento (\"Anti-Limbo\"), con entornos de producción y staging separados y despliegue controlado por branch." },
      { id: "dashboard-financeiro", name: "Dashboard Financiero", tag: "BI · Business Intelligence", trophy: "// ENTREGADO Y VALIDADO · SQL + BI", desc: "Modelado completo del estado de resultados industrial (ingresos brutos, COGS, margen bruto, EBITDA, utilidad neta) a partir de los asientos financieros del ERP, con panel ejecutivo de KPIs y validación de paridad 1:1 contra los reportes nativos." },
      { id: "infra-comunicacao", name: "Migración de Infraestructura", tag: "Infraestructura · Migración de sistemas", trophy: "// COMPLETADO · GOOGLE WORKSPACE + TWILIO", desc: "Migración de ~50 cuentas de correo a Google Workspace, con estrategia de mezcla de planes para reducir el costo de licenciamiento, y migración del canal de soporte de SMS a WhatsApp vía Twilio/WABA." },
    ],
    moreEyebrow: "// más proyectos",
    moreH2a: "Sin pantalla que mostrar,",
    moreH2b: "resultado que probar.",
  },
  sites: {
