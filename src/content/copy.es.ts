...
export const copyEs: Copy = {
  ...
  projects: {
    ...
    list: [
      ...
      { id: "infra-comunicacao", name: "Migración de Infraestructura", tag: "Infraestructura · Migración de sistemas", trophy: "// COMPLETADO · GOOGLE WORKSPACE + TWILIO", desc: "Migración de ~80 cuentas de correo a Google Workspace, con estrategia de mezcla de planes para reducir el costo de licenciamiento, y migración del canal de soporte de SMS a WhatsApp vía Twilio/WABA." },
    ],
